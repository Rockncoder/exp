        ...
        execute: function() {
            ...
            QuizService = (function () {
                ...
                QuizService.prototype.getQuizzes = function () {
                    var quizzes = [];
                    // remind class on the difference between for-in and for-of
                    for (var _i = 0, quizList_1 = quizList; _i < quizList_1.length; _i++) {
                        var quiz = quizList_1[_i];
                        quizzes.push({
                            title: quiz.title,
                ...
                QuizService.prototype.getQuiz = function (id) {
                    for (var _i = 0, quizList_2 = quizList; _i < quizList_2.length; _i++) {
                        var quiz = quizList_2[_i];
                        if (quiz._id === id) {
                            return quiz;
                        }
                    }
